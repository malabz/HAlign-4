...
public:
    ...
    SmpCommandLine( int argc, char *const argv[] )
    {
        ...
        */
        helpMessageQueue.emplace_back( std::string("Usage of ") + arguments[0] + ":");
        helpMessageQueue.emplace_back( arguments[0] + " [argument1] ... [--flag1 arg] ..." );
    ...
    {
        std::cout << "\nUsage:\n";
        std::cout << "  " << arguments[0] << " <dataset_fasta> <reference_fasta> <output_prefix> [options]\n\n";

        std::cout << "Positional arguments:\n";
        std::cout << "  dataset_fasta        Input dataset FASTA file containing query sequences.\n";
        std::cout << "  reference_fasta      Reference FASTA file (should contain exactly one sequence).\n";
        std::cout << "  output_prefix        Prefix for output files (e.g., output_prefix.fasta / output_prefix.vcf).\n\n";

        std::cout << "Optional arguments:\n";
        std::cout << "  -t, --threads <int>  Number of threads to use (default: 1).\n";
        std::cout << "  -s, --save-vcf       Enable VCF output generation.\n";
        std::cout << "  -h, --help           Show this help message.\n\n";

        std::cout << "Example:\n";
        std::cout << "  " << arguments[0] << " data/input.fasta ref/refseq.fasta out/result -t 16 -s\n\n";
...
protected:
                         ...
                         const char* helpMsg, bool bIsBoolean = false )
    {
        ...
        helpMessageQueue.emplace_back(helpStr);
    };
